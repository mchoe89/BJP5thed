// Write a method called largerAbsVal that takes two integers as parameters and returns the larger of the two absolute
...
public class LargerAbsVal {
    ...
    public static int largerAbsVal(int n, int m) {
