// Write a method called printPowersOf2 that accepts a maximum number as an argument and prints each power of 2 from 2^0
// (1) up to that maximum power, inclusive. For example, consider the following calls:
//    printPowersOf2(3);
//    printPowersOf2(10);
...
// number in your output. Also, can you write this program without using the Math class?)
